...
def main(config: ConfigParser):
    ...
    train_loss = config.initialize('train_loss', module_loss,data_loader.train_dataset.train_labels)
...
if __name__ == '__main__':
    ...
    options = [
        ...
        CustomArgs(['--lr_v', '--learning_rate_v'], type=float, target=('lr_v',), default = 10),
